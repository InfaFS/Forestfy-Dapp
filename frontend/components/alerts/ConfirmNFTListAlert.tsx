...
interface ConfirmNFTListAlertProps {
  show: boolean;
  onClose: () => void;
  onConfirm: () => void;
  nftName: string;
...
export const ConfirmNFTListAlert: React.FC<ConfirmNFTListAlertProps> = ({ 
  show, 
  onClose, 
  onConfirm, 
  nftName, 
    ...
    >
      <View style={styles.alertContent}>
        ...
        <Text style={styles.subtitle}>
          Are you sure you want to list {nftName} for {price} FTK?
        </Text>
